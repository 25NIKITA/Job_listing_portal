        ...
        <div className='bg-[#FAFAFA] py-10 px-4 1g:px-16'>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className='lg:w-1/2 w-full'>
                  ...
                  <input type='date' placeholder="2023-10-28"{...register('postingDate')} className='create-job-input'/>
                </div>
                <div className='lg:w-1/2 w-full'>
              ...
              {/**seventh Row */}
               ...
               <textarea className="w-full pl-3 py-1.5 focus:outline-none placeholder:text-gray-600"
                rows={6}
                defaultValue={"MERN Stack Job Portal using React, MongoDB, Node, Express.js & Tailwind CSS | Part 2"}
