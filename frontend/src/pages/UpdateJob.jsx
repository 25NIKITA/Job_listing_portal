        ...
        <div className='bg-[#FAFAFA] py-10 px-4 1g:px-16'>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className='lg:w-1/2 w-full'>
                  ...
                  <input type='date' placeholder="2023-10-28" defaultValue={postingDate}{...register('postingDate')} className='create-job-input'/>
                </div>
                <div className='lg:w-1/2 w-full'>
              ...
              <div className='lg:w-1/2 w-full'>
                  ...
                  defaultValue={companyLogo}{...register('companyLogo')} className='create-job-input'/>
                </div>
                <div className='lg:w-1/2 w-full'>
